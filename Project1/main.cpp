...
int main(void)
{
	...
	// Skybox
	ss << SOLUTION_DIR << "Extern\\assets\\models\\skycube\\skycube_tga\\skyrender0001.tga";
	std::string posXFile = ss.str();
	ss.str("");

	ss << SOLUTION_DIR << "Extern\\assets\\models\\skycube\\skycube_tga\\skyrender0002.tga";
	std::string negXFile = ss.str();
	ss.str("");

	ss << SOLUTION_DIR << "Extern\\assets\\models\\skycube\\skycube_tga\\skyrender0003.tga";
	std::string posYFile = ss.str();
	ss.str("");

	ss << SOLUTION_DIR << "Extern\\assets\\models\\skycube\\skycube_tga\\skyrender0004.tga";
	std::string negYFile = ss.str();
	ss.str("");

	ss << SOLUTION_DIR << "Extern\\assets\\models\\skycube\\skycube_tga\\skyrender0005.tga";
	std::string posZFile = ss.str();
	ss.str("");

	ss << SOLUTION_DIR << "Extern\\assets\\models\\skycube\\skycube_tga\\skyrender0006.tga";
